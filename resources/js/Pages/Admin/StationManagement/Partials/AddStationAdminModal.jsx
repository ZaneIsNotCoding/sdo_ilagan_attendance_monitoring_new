...
import { Search, Check, UserRound, LandPlot, BadgeCheck } from "lucide-react";
...
const AssignStationAdminModal = ({
    ...
    const filteredEmployees = useMemo(() => {
        return employees
            .filter(
                (emp) => !emp.station_id || emp.station_id == selectedStation,
            )
            .filter((emp) =>
    ...
    }, [employees, selectedStation, search]);
                ...
                <div className="space-y-4 px-5 pb-5 pt-1">
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                        ...
                        <Button
                            ...
                            disabled={!selectedEmployee || !selectedStation}
